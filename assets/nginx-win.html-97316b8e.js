...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li><li><p><strong>停止某个进程的 Nginx</strong>:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>taskkill /pid *** /f
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li></ol><ul><li><p><code>***</code>代表的是<code>pid</code>码，结束哪个就替换为哪个<code>pid</code>码</p></li><li><p>比如我要结束<code>pid</code>为<code>31586</code>的<code>nginx</code></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>taskkill /pid 31586 /f
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li></ul><h3 id="_6-其他配置" tabindex="-1"><a class="header-anchor" href="#_6-其他配置" aria-hidden="true">#</a> 6. 其他配置</h3><ol><li><p><strong>设置其他静态资源路径</strong>:</p><ul><li>可以根据需要在 <code>nginx.conf</code> 中添加更多的 <code>location</code> 块来处理不同的路径。</li><li>这个代表当你浏览器访问<code>web</code>文件夹<code>(http://1.23.45.9/web)</code>时候会给你跳转到<code>C:/Users/Administrator/Downloads/nginx-1.24.0/nginx-1.24.0/html/web/;</code>文件夹下的内容</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code> location /web/ {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li></ol>`,15),s=[a];function o(t,c){return i(),n("div",null,s)}const u=e(l,[["render",o],["__file","nginx-win.html.vue"]]);export{u as default};
